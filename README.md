...
Студент 4 курса ВМК МГУ, активно развиваюсь в направлении frontend-разработки. Работаю в проекте по созданию системы автоматизированного тестирования сетевого процессорного устройства. В мои задачи входит разработка новых, чаще всего интерактивных, компонентов, а также доработка имеющихся экранов системы. Также этим летом прошёл стажировку в Сбере продуктовым аналитиком. Работал с интерфейсами, клиентскими путями и воронками, а также с фронтовыми событиями и аналитикой по ним.
...
* **REST API** — интеграция frontend с backend, получение, обработка и отображение данных
...
* **Swagger** — изучение документации API, проверка и тестирование REST-запросов
* **Docker** — работа с контейнеризированным окружением проекта
